...
from student_04.project.student import Student
...
class TestStudent(TestCase):
    ...
    def test_enroll_course_with_notes_with_empty_course_notes_scenario(self):
    ...
    def test_enroll_course_with_notes_with_Y_course_notes_scenario(self):
    ...
    def test_enroll_course_with_notes_without_saving_them(self):
        result = self.student_1.enroll("Python OOP", ["Inheritance", "SOLID"], "Note")
        self.assertEqual(1, len(self.student_1.courses))
