...
class IContent:
    ...
    def format(self, format, content=None, available_formats={}):
        ...
        if not content:
            raise TypeError('Must provide input')
...
FORMAT_MAPPER = {'myml': IContent.myml_format,
                     'html': IContent.html_format,
                     'basic': IContent.basic_format,
}
...
email.set_content(content.format(format="MyMl", available_formats=FORMAT_MAPPER))
print(email)
